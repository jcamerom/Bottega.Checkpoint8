## Checkpoint 8: Javascript moderno.

En este apartado vamos a resolver las siguientes tareas:

**- Elaborar documentación utilizando Markdown en el apartado "Wiki" del repositorio de GitHub. Vamos a revisar los siguientes apartados:**
